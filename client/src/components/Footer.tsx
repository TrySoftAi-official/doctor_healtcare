          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-white leading-relaxed mb-4">
                Providing compassionate healthcare services for families and individuals of all ages.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Elder Wellness', 'Home Care Visits', 'General Checkups', 'Heart Care'].map((service) => (
                  <li key={service}>
                    <a href="#" className="text-white hover:text-blue-200 transition-colors">
                      {service}
                    </a>
